...
public class Base32 {
    ...
    public static char[] encode(char[] input, char[] alphabet) {
    ...
    public static char[] decode(char[] input, char[] alphabet) {
        long num = 0;
        for (char c : input) {
            int pos = 0;
    ...
    public static void main(String[] args) {
        ...
        char[] text = {'H', 'e', 'l', 'l', 'o', ',', ' ', 'B', 'a', 's', 'e', '5', '8', ' ', 'E', 'n', 'c', 'o', 'd', 'e', 'r'};
        String text2 = "Hello, Base58 Encoder";
        char[] encoded = encode(text2.toCharArray(), alphabet);
        ...
        char[] decoded = decode(encoded, alphabet);
